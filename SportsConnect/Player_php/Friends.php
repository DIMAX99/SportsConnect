...
<body>
                ...
                <h3>Chats</h3>
                    ...
                    <div class="message-send-input">
                        <form action="" id="typing-area" autocomplete="off">
                            ...
                            <input type="text" placeholder="Type a message here...." id="message" class="message" name="message">
    ...
    <script>
        ...
        var lastMessageId;
        var chatlist;
        function autoupdatemsg(chatcontainer,to_friend_id,lastmsgid){
            console.log(chatcontainer);
            console.log(to_friend_id);
            console.log(lastmsgid);
            $.ajax({
                type:'post',
                url:'../support_php/ajax-live-update-chat.php',
                dataType:'json',
                data:{to_friend_id:to_friend_id,lastMessageId:lastmsgid},
                success:function(response){
                    if(response.chatOutput.trim()!==""){
                    chatcontainer.innerHTML+=response.chatOutput;
        ...
        $(document.body).on('click','.m',function(){
            ...
            // console.log(friend_id);
                ...
                success:function(r){
                    ...
                    chat_div.innerHTML=responseObj.chatOutput;
                    lastMessageId = responseObj.lastMessageId;
                    chatlist =document.querySelector('#chats-list');
                    chatlist.scrollTop = chatlist.scrollHeight;
                    setInterval(function(){autoupdatemsg(chatlist,friend_id,lastMessageId);},500);
                }
