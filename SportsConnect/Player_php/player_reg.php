...
$uni="select unique_id from player";
$uni_stmt=$con->prepare($uni);
$uni_stmt->execute();
$u=$uni_stmt->fetchAll(PDO::FETCH_COLUMN);
do{
    $unique_id=random_int(10000,99999);
}
while(in_array($unique_id,$u));
...
if($stmt->rowCount()>0){
    ...
    $insert="insert into player(unique_id,fname, mname, lname, dob, age, gender, email, country_id, state_id, city_id, country_code, phonenumber, image, username, password,consent) values(:unique_id,:fname, :mname, :lname, :dob, :age, :gender, :email, :country_id, :state_id, :city_id, :country_code, :phonenumber, :image, :username, :hashedpass,:consent)";
    $final=$con->prepare($insert);
    $final->bindParam(':unique_id',$unique_id);
    ...
    $final->bindParam(":consent",$consent);
    ...
    <div class="container" id="container">
        <form id="regform" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="consent" id="consent">
                ...
                <label for="consent">Would you like to allow other Players in your city to view your profile?</label>
            </div>
